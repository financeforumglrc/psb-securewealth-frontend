...
## 5. SME Centre
**Path:** Navigation **Family & Lifestyle** → **SME Centre**

Tabs verified:
1. **Cash Flow Timeline** — chart renders (Apr–Mar cash flow).
2. **Surplus Fund Advisor** — shows current idle surplus ₹5,50,000.
