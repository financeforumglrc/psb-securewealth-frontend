...
const DemoMode = lazyWithRetry(() => import('./components/demo/DemoMode'));

const SecurityBeastView = lazyWithRetry(() => import('./components/security/SecurityBeastView'));
const DecoyAccountView = lazyWithRetry(() => import('./components/security/DecoyAccountView'));

const ProtectionView = lazyWithRetry(() => import('./components/protection/ProtectionView'));
const PrivacyView = lazyWithRetry(() => import('./components/privacy/PrivacyView'));

const BiometricAuth = lazyWithRetry(() => import('./components/auth/BiometricAuth'));
...
const WealthTwinView = lazyWithRetry(() => import('./components/ai/WealthTwinView'));
const AIRecommendationsView = lazyWithRetry(() => import('./components/ai/AIRecommendationsView'));
const PortfolioView = lazyWithRetry(() => import('./components/portfolio/PortfolioView'));
const MarketView = lazyWithRetry(() => import('./components/market/MarketView'));
const TaxView = lazyWithRetry(() => import('./components/tax/TaxView'));
const CalculatorsView = lazyWithRetry(() => import('./components/calculators/CalculatorsView'));
const TransactionsView = lazyWithRetry(() => import('./components/transactions/TransactionsView'));
const BillCalendar = lazyWithRetry(() => import('./components/bills/BillCalendar'));
const CreditHealth = lazyWithRetry(() => import('./components/credit/CreditHealth'));
const BhavishyaEngine = lazyWithRetry(() => import('./components/innovation/BhavishyaEngine'));
const InnovationOverview = lazyWithRetry(() => import('./components/innovation/InnovationOverview'));
const NeuroFrictionWidget = lazyWithRetry(() => import('./components/innovation/NeuroFrictionWidget'));
const MonteCarloSimulator = lazyWithRetry(() => import('./components/innovation/MonteCarloSimulator'));
const CollectiveImmuneSystem = lazyWithRetry(() => import('./components/innovation/CollectiveImmuneSystem'));
const AutonomousAgent = lazyWithRetry(() => import('./components/innovation/AutonomousAgent'));
const SovereignVault = lazyWithRetry(() => import('./components/innovation/SovereignVault'));
const ParametricInsurance = lazyWithRetry(() => import('./components/insurance/ParametricInsurance'));
const GhostMode = lazyWithRetry(() => import('./components/security/GhostMode'));
const DeadMansSwitch = lazyWithRetry(() => import('./components/security/DeadMansSwitch'));
const GigIncomeSmoother = lazyWithRetry(() => import('./components/income/GigIncomeSmoother'));
const SocialCollateralLoan = lazyWithRetry(() => import('./components/loans/SocialCollateralLoan'));
const FantasyLeague = lazyWithRetry(() => import('./components/gamification/FantasyLeague'));
const BoostsManager = lazyWithRetry(() => import('./components/goals/BoostsManager'));
const ValuesAlignment = lazyWithRetry(() => import('./components/values/ValuesAlignment'));
const AccessibilitySettings = lazyWithRetry(() => import('./components/accessibility/AccessibilitySettings'));
const NRIMode = lazyWithRetry(() => import('./components/nri/NRIMode'));
const SeniorMode = lazyWithRetry(() => import('./components/senior/SeniorMode'));
const BusinessMode = lazyWithRetry(() => import('./components/business/BusinessMode'));
const LoanCenter = lazyWithRetry(() => import('./components/banking/LoanCenter'));
const RecurringPayments = lazyWithRetry(() => import('./components/banking/RecurringPayments'));
const AccountStatement = lazyWithRetry(() => import('./components/banking/AccountStatement'));
const AuditLog = lazyWithRetry(() => import('./components/banking/AuditLog'));
  ...
  useEffect(() => {
    ...
    const prefetchViews = () => {
      ...
      const views = [
        ...
        () => import('./components/ai/WealthTwinView'),
        () => import('./components/portfolio/PortfolioView'),
        () => import('./components/market/MarketView'),
        () => import('./components/transactions/TransactionsView'),
        () => import('./components/goals/GoalTracker'),
      ];
