...
import { protectionApi, type ProtectionResponse } from '@/shared/lib/protectionApi';
import { getGuardianMessage } from '@/shared/services/guardianService';
import FamilyApprovalGate from '@/features/protection/components/FamilyApprovalGate';
