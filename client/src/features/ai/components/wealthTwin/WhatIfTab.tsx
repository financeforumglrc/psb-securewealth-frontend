        ...
        <div className="lg:col-span-1 space-y-4">
          <div className="card">
            ...
            <div className="space-y-4">
              <RangeInput label="Monthly Savings" value={whatIfSavings} min={0} max={user.monthlyIncome} step={1000} prefix="₹" onChange={setWhatIfSavings} />
              <RangeInput label="Expected Annual Returns" value={whatIfReturns} min={5} max={20} step={0.5} suffix="%" onChange={setWhatIfReturns} />
              <RangeInput label="Projection Years" value={whatIfYears} min={5} max={30} step={1} suffix=" years" onChange={setWhatIfYears} />
              <RangeInput label="Major One-Time Expense" value={whatIfExpense} min={0} max={5000000} step={100000} prefix="₹" onChange={setWhatIfExpense} />
            </div>
          </div>
  ...
  return (
    <div>
      <div className="flex justify-between text-xs mb-1">
        ...
        <span className="font-bold text-primary">{prefix}{value.toLocaleString()}{suffix}</span>
      </div>
      <input
        type="range"
        min={min}
