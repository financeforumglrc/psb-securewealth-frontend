...
import { useForecastEngine } from '@/shared/hooks/useForecastEngine';
import { formatCurrency } from '@/shared/utils/demoMode';
import { SCENARIO_OPTIONS, runScenario, type ScenarioResult } from '@/shared/services/scenarioEngine';
