...
import { getLeagues, getLeaderboard, generateScoutingReport, type FantasyPlayer, type FantasyLeague, type ScoutingReport } from '@/shared/services/leagueService';
import FantasyPortfolio from '@/features/gamification/components/FantasyPortfolio';
