      ...
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-slate-900 via-slate-800 to-primary-dark p-6 sm:p-8 text-white">
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-2 mb-3">
            <span className="px-2 py-0.5 bg-amber-400 text-slate-900 dark:text-white text-[10px] font-extrabold rounded-full uppercase tracking-wider">{t('innovationOverviewBadge')}</span>
        ...
        {FEATURES.map((f, i) => (
          ...
          >
            <div className={`relative h-full p-4 rounded-2xl border transition-all duration-300 ${
              ...
              {f.badge === 'WORLD FIRST' && (
                <span className="absolute top-3 right-3 text-[10px] px-1.5 py-0.5 bg-amber-100 dark:bg-amber-900/30 text-amber-700 dark:text-amber-300 rounded-full font-extrabold">
                  {f.badge}
                </span>
              )}
              ...
              <div className="flex items-end justify-between">
                <div>
                  ...
                  <p className="text-[10px] text-slate-400 dark:text-slate-500">{f.statLabel}</p>
                </div>
                <div className="w-8 h-8 rounded-full bg-slate-50 dark:bg-slate-700 flex items-center justify-center text-slate-400 dark:text-slate-500 group-hover:bg-primary group-hover:text-white transition-colors">
          ...
          {[
            ...
            <div key={section.stage} className="flex items-start gap-3">
              <span className={`text-[10px] px-2 py-0.5 rounded-full font-bold flex-shrink-0 mt-0.5 ${
                ...
                section.stage === 'Beta' ? 'bg-amber-100 dark:bg-amber-900/30 text-amber-700 dark:text-amber-300' :
