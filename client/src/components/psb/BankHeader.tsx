  ...
  return (
    <header className="bg-primary text-white shadow-sm sticky top-0 z-50">
      ...
      <div className="bg-primary-dark border-b border-white/10">
        <div className="max-w-[1440px] mx-auto px-4 lg:px-8 flex items-center justify-between h-8 text-[11px]">
          ...
          <div className="flex items-center gap-4">
            <NetworkStatusBadge />
            <button className="hover:text-white/80 transition-colors hidden sm:block text-[11px]">Internet Banking</button>
            <button
        ...
        <div className="flex items-center justify-between h-[60px]">
          ...
          <nav className="hidden xl:flex items-center gap-0.5">
            {NAV_LINKS.map((link) => (
              <button
                ...
                className={`px-3.5 py-2 rounded-sm text-[13px] font-semibold transition-colors tracking-tight ${
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="xl:hidden w-9 h-9 flex items-center justify-center rounded-sm hover:bg-white/10"
            >
      ...
      {/* Yellow strip - Punjab & Sind Bank tagline */}
      <div className="bg-secondary border-t border-secondary-dark/20">
        <div className="max-w-[1440px] mx-auto px-4 lg:px-8 flex items-center justify-between h-7">
          <p className="text-[11px] font-bold text-primary-dark tracking-wide">
            जहाँ सेवा ही जीवन-ध्येय है | Where service is a way of life
          </p>
          <p className="text-[10px] text-primary-dark/70 hidden sm:block">
