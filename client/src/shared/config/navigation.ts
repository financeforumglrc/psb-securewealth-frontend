...
export const VIEW_DESCRIPTIONS: Record<string, string> = {
  ...
  'business-mode': 'Business accounts, GST and invoice tracking.',
...
const lifestyleGroup: NavGroup = {
  ...
  items: [
    ...
    { view: 'business-mode', label: 'Business', icon: 'fa-building', description: 'GST, invoices and payouts.' },
